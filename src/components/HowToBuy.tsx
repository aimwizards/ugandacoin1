  ...
  const steps = [
    {
      ...
      number: 1,
      title: "Register",
      description: "Create an account on Swapmana with instant sign-up and get your free cryptocurrency wallet."
    },
    {
      icon: Search,
      number: 2,
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center">
          <p className="text-gray-600 max-w-2xl mx-auto">
            Swapmana is a decentralized peer-to-peer trading platform focused on privacy and security. 
